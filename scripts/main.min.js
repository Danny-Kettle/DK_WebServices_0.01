$(document).ready(function () {
  if($(window).width() <= 739){
    $('#servicesInnerContainer').toggleClass('slide-up slide-right');
  };
  ...
  $(".service-btn").click(function () {
    document.location.href = "https://www.dkwebservices.co.uk/services/";
  });
  $(".about-btn").click(function () {
    document.location.href = "https://www.dkwebservices.co.uk/about/";
  });
  $(".contact-btn").click(function () {
    document.location.href = "https://www.dkwebservices.co.uk/contact/";
  });
});
